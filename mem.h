...
#define CHARBOUND(value) (((value) > 255) ? 255 : (((value) < 0) ? 0 : (value)))

#define ILBOUND(ptr, index, value) ((index & 1) ? 0 : (((index) < (value)) ? ptr[(value) >> 1] : ptr[(index) >> 1]))
#define IUBOUND(ptr, index, value) ((index & 1) ? 0 : (((index) > (value)) ? ptr[(value) >> 1] : ptr[(index) >> 1]))
